-- Flyway 베이스라인 스크립트
-- 기존 DB 스키마를 정의합니다. (외래 키 제약 조건 이름 수정)
...
(
    product_id bigint not null
        constraint fk_product_style_tags_product
            references product,
...
(
    ...
    travel_outfit_id          bigint generated by default as identity
        primary key,
    updated_at                timestamp(6) not null,
    user_id                   bigint, -- 참고: 이 컬럼은 현재 외래 키 제약 조건이 없습니다.
    status                    varchar(20)
...
(
    post_id  bigint      not null
        -- (→ 수정) 제약 조건 이름 변경
        constraint fk_post_shares_posts
            references posts,
    share_id bigint generated by default as identity
        primary key,
    user_id  bigint      not null
        constraint fk_post_shares_users
            references users,
...
(
    ...
    user_category_feedback_id bigint generated by default as identity
        primary key,
    user_id                   bigint       not null
        constraint fk_user_category_feedback_users
            references users,
...
(
    created_at            timestamp(6) not null,
    product_id            bigint       not null
        constraint fk_user_item_feedback_product
            references product,
    updated_at            timestamp(6) not null,
    user_id               bigint       not null
        constraint fk_user_item_feedback_users
            references users,
...
(
    ...
    region_id     bigint
        constraint fk_weather_region_grid

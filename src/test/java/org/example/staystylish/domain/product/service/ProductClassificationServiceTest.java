...
class ProductClassificationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        ChatClient realChatClientWiredToMockModel = ChatClient.builder(mockChatModel).build();
        when(chatClientBuilder.build()).thenReturn(realChatClientWiredToMockModel);
        productClassificationService = new ProductClassificationService(chatClientBuilder, objectMapper);
    }
        ...
        class Context_with_malformed_json {
            ...
            void it_throws_runtime_exception() {
                ...
                RuntimeException exception = assertThrows(RuntimeException.class, () -> {
                    productClassificationService.classify(requestDto);
                });
